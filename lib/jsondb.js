...
function createStore(filePath) {
  ...
  if (!data || typeof data !== 'object') {
    data = { users: [], sessions: [], messages: [], pushSubscriptions: [], posts: [], passwordResets: [], tasks: [], notifications: [], polls: [], stories: [] };
  }
  for (const key of ['users', 'sessions', 'messages', 'pushSubscriptions', 'posts', 'passwordResets', 'tasks', 'notifications', 'polls', 'stories']) {
