...
function createStore(filePath) {
  ...
  if (!data || typeof data !== 'object') {
    data = { users: [], sessions: [], expenses: [], messages: [], pushSubscriptions: [], posts: [], passwordResets: [] };
  }
  for (const key of ['users', 'sessions', 'expenses', 'messages', 'pushSubscriptions', 'posts', 'passwordResets']) {
